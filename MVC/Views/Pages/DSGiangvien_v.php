...
<body>
    <main class="table" id="students_table">
        <section class="table__header">
            ...
            <form action="http://QLHS - test/DSGiangvien/timkiem" method="post">         
            ...
            <div class="Insert">
                <form action="http://QLHS - test/Giangvien" method="post">
                    <button class="button-85" role="button">Thêm giảng viên</button>
                </form>
            </div>
            <div class="Upload">
                <form action="http://QLHS - test/DSGiangvien/uploadExcel" method="post" enctype="multipart/form-data">
            ...
            <div class="export__file">
                ...
                <div class="export__file-options">
                    ...
                    <form action="http://QLHS - test/DSGiangvien/exportExcel" method="post">
                ...
                <tbody>
                    <?php
                        ...
                        ?>
                                    ...
                                    <td class="btn_cn">
                                        <form action="http://QLHS - test/DSGiangvien/sua/<?php echo $row['ma_giang_vien'] ?>" method="post">
                                            <button class="button-85" role="button">Sửa</button>
                                        </form>
                                        <form action="http://QLHS - test/DSGiangvien/xoa/<?php echo $row['ma_giang_vien'] ?>" method="post">
