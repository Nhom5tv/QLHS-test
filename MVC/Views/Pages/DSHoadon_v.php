...
<body>
    <form method="post" action="http://QLHS - test/DSHoadon/timkiem"></form>
    <main class="table" id="customers_table">
        <section class="table__header">
            <h1>Quản lý hóa đơn</h1>
           
            <div class="input-group"> 
            <form action="http://QLHS - test/DSHoadon/timkiem" method="post">         
            ...
            <div class="Insert">
                <form action="http://QLHS - test/DSHoadon/themmoi" method="post">
                <button class="button-85" role="button">Thêm hóa đơn</button>
                </form>
            </div>

            <div class="Upload">
                <form action="http://QLHS - test/DSHoadon/uploadExcel" method="post" enctype="multipart/form-data">
            ...
            <div class="export__file">
                ...
                <div class="export__file-options">
                    ...
                    <form action="http://QLHS - test/DSHoadon/exportExcel" method="post">
                            ...
                            while($row=mysqli_fetch_assoc($data['dulieu'])){
                                ?>
                                    <tr>
                                        ...
                                        echo '<form action="http://QLHS - test/DSHoadon/sua/' . $row['ma_hoa_don'] . '" method="post">';
                                        echo '<button class="button-85" role="button">Sửa</button>  ';
                                        echo '</form>';

                                        // Hiển thị nút Xóa
                                        echo '<form action="http://QLHS - test/DSHoadon/xoa/' . $row['ma_hoa_don'] . '" method="post">';
