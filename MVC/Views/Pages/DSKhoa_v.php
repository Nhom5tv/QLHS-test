...
<body>
    <main class="table" id="students_table">
        <section class="table__header">
            ...
            <form action="http://QLHS - test/DSKhoa/timkiem" method="post">         
            ...
            <div class="Insert">
                <form action="http://QLHS - test/Khoa" method="post">
                    <button class="button-85" role="button">Thêm khoa</button>
                </form>
            </div>
            <div class="Upload">
                <form action="http://QLHS - test/DSKhoa/uploadExcel" method="post" enctype="multipart/form-data">
            ...
            <div class="export__file">
                ...
                <div class="export__file-options">
                    ...
                    <form action="http://QLHS - test/DSKhoa/exportExcel" method="post">
                        ...
                        if(isset($data['dulieu']) && mysqli_num_rows($data['dulieu'])>0 ){
                            while($row=mysqli_fetch_assoc($data['dulieu'])){
                                ...
                                <tr>
                                    ...
                                    <td class="btn_cn">
                                        <form action="http://QLHS - test/DSKhoa/sua/<?php echo $row['ma_khoa'] ?>" method="post">
                                            <button class="button-85" role="button">Sửa</button>
                                        </form>
                                        <form action="http://QLHS - test/DSKhoa/xoa/<?php echo $row['ma_khoa'] ?>" method="post">
