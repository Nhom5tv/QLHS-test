...
<body>
    <form method="post" action="http://QLHS - test/DSKhoanthu/timkiem"></form>
    <main class="table" id="customers_table">
        <section class="table__header">
            <h1>Quản lý khoản thu</h1>
           
            <div class="input-group"> 
            <form action="http://QLHS - test/DSKhoanthu/timkiem" method="post">         
            ...
            <div class="Insert">
                <form action="http://QLHS - test/DSKhoanthu/themmoi" method="post">
                <button class="button-85" role="button">Thêm khoản thu</button>
                </form>
            
            </div>
            <div class="Upload">
                <form action="http://QLHS - test/DSKhoanthu/uploadExcel" method="post" enctype="multipart/form-data">
            ...
            <div class="export__file">
                ...
                <div class="export__file-options">
                    ...
                    <form action="http://QLHS - test/DSKhoanthu/exportExcel" method="post">
    ...
    echo '<form action="http://QLHS - test/DSKhoanthu/sua/' . $row['ma_khoan_thu'] . '" method="post">';
    echo '<button class="button-85" role="button">Sửa</button>  ';
    echo '</form>';

    // Hiển thị nút Xóa
    echo '<form action="http://QLHS - test/DSKhoanthu/xoa/' . $row['ma_khoan_thu'] . '" method="post">';
