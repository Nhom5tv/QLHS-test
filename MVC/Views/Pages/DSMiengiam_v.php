...
<head>
    ...
    <link rel="stylesheet" href="http://QLHS - test/Public/CSS/styleDT.css">
    <style>
        .btn_cn {
            display: flex;
            margin: 0;
...
<body>
    <form method="post" action="http://QLHS - test/DSMiengiam/timkiem"></form>
    <main class="table" id="customers_table">
        <section class="table__header">
            <h1>Quản lý miễn giảm </h1>
           
            <div class="input-group">
                <form action="http://QLHS - test/DSMiengiam/timkiem" method="post">
            ...
            <div class="Insert">
                <form action="http://QLHS - test/DSMiengiam/themmoi" method="post">
                    <button class="button-85" role="button">Thêm miễn giảm</button>
                </form>
            </div>
            <div class="Upload">
                <form action="http://QLHS - test/DSMiengiam/uploadExcel" method="post" enctype="multipart/form-data">
            ...
            <div class="export__file">
                ...
                <div class="export__file-options">
                    ...
                    <form action="http://QLHS - test/DSMiengiam/exportExcel" method="post">
                    ...
                    if (isset($data['dulieu']) && mysqli_num_rows($data['dulieu']) > 0) {
                        while ($row = mysqli_fetch_assoc($data['dulieu'])) {
                            ...
                            <tr>
                                ...
                                <td class="btn_cn">
                                    <form action="http://QLHS - test/DSMiengiam/sua/<?php echo $row['ma_mien_giam']; ?>" method="post">
                                        <button class="button-85" role="button">Sửa</button>
                                    </form>
                                    <form action="http://QLHS - test/DSMiengiam/xoa/<?php echo $row['ma_mien_giam']; ?>" method="post">
