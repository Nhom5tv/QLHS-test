...
<body>
    <main class="table" id="students_table">
        <section class="table__header">
            ...
            <form action="http://qlhs/DSNganh/timkiem" method="post">         
            ...
            <div class="Insert">
                <form action="http://qlhs/Nganh" method="post">
                    <button class="button-85" role="button">Thêm ngành</button>
                </form>
            </div>
            <div class="Upload">
                <form action="http://qlhs/DSNganh/uploadExcel" method="post" enctype="multipart/form-data">
            ...
            <div class="export__file">
                ...
                <div class="export__file-options">
                    ...
                    <form action="http://qlhs/DSNganh/exportExcel" method="post">
    ...
    ?>
                                    ...
                                    <td class="btn_cn">
                                        <form action="http://qlhs/DSNganh/sua/<?php echo $row['ma_nganh'] ?>" method="post">
                                            <button class="button-85" role="button">Sửa</button>
                                        </form>
                                        <form action="http://qlhs/DSNganh/xoa/<?php echo $row['ma_nganh'] ?>" method="post">
