...
<body>
    <form method="post" action="http://QLHS - test/DSSanpham/timkiem"></form>
    <main class="table" masp="customers_table">
        <section class="table__header">
            <h1>Quản lý sản phẩm</h1>
           
            <div class="input-group"> 
            <form action="http://QLHS - test/DSSanpham/timkiem" method="post">         
            ...
            <div class="Insert">
                <form action="http://QLHS - test/Sanpham" method="post">
                                    ...
                                    <tr>
                                     ...
                                     <?php
                                        ...
                                        if (is_file($hinhanhpath)) {
                                            ...
                                            <td class="btn_cn">
                                            <form action="http://QLHS - test/DSSanpham/sua/<?php echo $row['Masp']?>" method="post">
                                                <button class="button-85"  role="button">Sửa</button> &nbsp;
                                            </form>
                                               <form action="http://QLHS - test/DSSanpham/xoa/<?php echo $row['Masp']?>" method="post">
