...
<body>
    ...
    <main class="table" id="customers_table">
        <section class="table__header">
            ...
            <form action="http://QLHS/DSTaikhoan/timkiem" method="post">         
    ...
    document.addEventListener("click", function(event) {
        ...
        if (!input.contains(event.target) && !dropdown.contains(event.target)) {
            ...
            <div class="Insert">
                <form action="http://QLHS/Taikhoan" method="post">
                <button class="button-85" role="button">Thêm tài khoản</button>
                </form>
            
            </div>
            <div class="Upload">
                <form action="http://QLHS/DSTaikhoan/uploadExcel" method="post" enctype="multipart/form-data">
            ...
            <div class="export__file">
                ...
                <div class="export__file-options">
                    ...
                    <form action="http://QLHS/DSTaikhoan/exportExcel" method="post">
...
if ($row['phan_quyen'] == 'giang_vien' || $row['phan_quyen'] == 'sinh_vien' ) {
    ...
    echo '<form action="http://QLHS/DSTaikhoan/sua/' . $row['ma_tai_khoan'] . '" method="post">';
    echo '<button class="button-85" role="button">Sửa</button> ';
    echo '</form>';

    // Hiển thị nút Xóa
    echo '<form action="http://QLHS/DSTaikhoan/xoa/' . $row['ma_tai_khoan'] . '" method="post">';
