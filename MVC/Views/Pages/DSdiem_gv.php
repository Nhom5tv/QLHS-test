...
<body>
    ...
    <div class="flex-container">
        <!-- Select box -->
        <form action="http://QLHS - test/DSdiemtungmon_gv" method="post" class="form-container">
        ...
        <?php if (isset($_POST['class_id']) || isset($_GET['class_id'])): ?>
            <a href="http://QLHS - test/DSdiemtungmon_gv/exportExcel?class_id=<?= $_POST['class_id'] ?? $_GET['class_id'] ?>" class="button-85">Xuất Excel</a>
        <?php endif; ?>
        <div class="input-group" style="margin-left: 150px;" > 
            <form action="http://QLHS - test/DSdiemtungmon_gv/Get_data" method="post"> 
            ...
            <table>
                ...
                <?php
                    ...
                    <tr>
                        ...
                        <td class="btn_cn">
                            <form action="http://QLHS - test/DSdiemtungmon_gv/sua/<?php echo $row['ma_dct']; ?>" method="post">
                                <input type="hidden" name="class_id" value="<?php echo isset($_POST['class_id']) ? $_POST['class_id'] : ''; ?>">
