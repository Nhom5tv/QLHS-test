...
<body style="display: block;">
    <form method="post" action="http://QLHS - test/Svdktinchi/timkiem"></form>
    ...
    <main class="table" id="customers_table">
        <section class="table__header">
            ...
            <form action="http://QLHS - test/Svdktinchi/timkiem" method="post">         
        ...
        while ($row = mysqli_fetch_assoc($data['dulieu'])) {
            ...
            <tr>
                ...
                <td class="btn_cn">
                    ...
                    <?php else : ?>
                        <!-- Nếu có thể đăng ký -->
                        <form action="http://QLHS - test/svdktinchi/dk" method="post">
        ...
        if (isset($data['dulieu2']) && mysqli_num_rows($data['dulieu2']) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($data['dulieu2'])) {
                ...
                <tr>
                    ...
                    <td class="btn_cn">
                        <form action="http://QLHS - test/SVdktinchi/xoa/<?php echo $row['ma_dang_ky'] ?>" method="post">
