...
<body>
    <form method="post" action="http://qlhs/DSmonhoc/timkiem"></form>
    <main class="table" id="customers_table">
        <section class="table__header">
            <h1>Quản lý môn học</h1>
            <div class="input-group">
                <form action="http://qlhs/DSmonhoc/timkiem" method="post">        
            ...
            <div class="Insert">
                <form action="http://qlhs/monhoc" method="post">
                <button class="button-85" role="button">Thêm môn học</button>
                </form>
            </div>

            <div class="Upload">
                <form action="http://qlhs/DSmonhoc/uploadExcel" method="post" enctype="multipart/form-data">
            ...
            <div class="export__file">
                ...
                <div class="export__file-options">
                    ...
                    <form action="http://qlhs/DSmonhoc/exportExcel" method="post">
                        ...
                        if(isset($data['dulieu']) && mysqli_num_rows($data['dulieu'])>0) {
                            while($row = mysqli_fetch_assoc($data['dulieu'])) {
                                ...
                                <tr>
                                    ...
                                    <td class="btn_cn">
                                        <form action="http://qlhs/DSmonhoc/sua/<?php echo $row['ma_mon'] ?>" method="post">
                                            <button class="button-85" role="button">Sửa</button>
                                        </form>

                                        <form action="http://qlhs/DSmonhoc/xoa/<?php echo $row['ma_mon'] ?>" method="post">
